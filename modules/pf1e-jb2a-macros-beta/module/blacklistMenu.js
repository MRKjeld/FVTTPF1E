class BlacklistMenu extends FormApplication {
  async getData() {
    const settings = await game.settings.get("pf1e-jb2a-macros", "blacklist")
  ...
  async submit(html, updateAnimations) {
    ...
    await game.settings.set("pf1e-jb2a-macros", "blacklist", {
  ...
  static get defaultOptions() {
    return {
      ...
      id: "blacklistMenu",
      template: "modules/pf1e-jb2a-macros/templates/blacklist.hbs",
      width: 400,
    }
  }
}

pf1eAnimations.blacklistMenu = BlacklistMenu
