Hooks.once('sequencer.ready', () => {
    Sequencer.Presets.add("pf1eAnimations.breathe", (effect, args) => {
        return effect
    ...
    Sequencer.Presets.add("pf1eAnimations.orbit", (effect, args) => {
    ...
    Sequencer.Presets.add("pf1eAnimations.fade", (effect, args) => {
