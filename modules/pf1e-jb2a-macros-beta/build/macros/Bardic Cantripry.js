...
if (typeof args[0] === "string") {
  ...
  let songOfMarching = Sequencer.EffectManager.getEffects({
    name: "Song of Marching",
    source: token,
  })[0]
  let dirgeOfDoom = Sequencer.EffectManager.getEffects({
    name: "Dirge of Doom",
    source: token,
  })[0]
  if (songOfMarching || dirgeOfDoom) {
    ...
    switch (spellName) {
      ...
      default:
        console.log(`Can't find "${spellName}", probably unimplemented!`)
    }
  }
}
