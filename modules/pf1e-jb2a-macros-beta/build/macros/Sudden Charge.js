...
ui.notifications.info(
  game.i18n.localize("pf1e-jb2a-macros.macro.suddenCharge.notif")
)
...
for (let i = 0; i < 2; i++) {
    ...
    { tokenD },
    {
      crosshairConfig: {
        label: `${game.i18n.localize(
          "pf1e-jb2a-macros.macro.suddenCharge.suddenCharge"
        )} (${i + 1}/2)`,
      },
  ...
  await new Sequence({ moduleName: "PF1e Animations", softFail: true })
    .animation()
    .on(tokenD)
